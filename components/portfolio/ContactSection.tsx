      ...
      <SectionPanel>
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-lg border border-[#05DFD7]/60 bg-[rgba(5,223,215,0.05)] p-5 transition hover:translate-x-1 hover:bg-[rgba(5,223,215,0.12)]">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(5,223,215,0.2)] text-[#05DFD7]">
            ...
            <div>
              <h4 className="mb-3 text-base font-semibold text-[#05DFD7]">{t("socialTitle")}</h4>
              <div className="flex flex-wrap gap-3">
                {SOCIAL.map(({ href, icon, label }) => (
                  <a
                    ...
                    aria-label={label}
                    className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#05DFD7] text-[#05DFD7] transition hover:bg-[#05DFD7] hover:text-zinc-900 dark:hover:text-[#040404]"
                  >
