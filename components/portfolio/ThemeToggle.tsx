...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed left-4 top-4 z-[100] flex h-12 w-[7.25rem] shrink-0 items-center rounded-full border-4 border-zinc-900 bg-white shadow-sm transition-colors dark:border-zinc-100 dark:bg-zinc-950"
    >
      <span
